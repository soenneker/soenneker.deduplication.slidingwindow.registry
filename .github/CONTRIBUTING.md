# Contributing to Soenneker.Deduplication.SlidingWindow.Registry
...
1. **Create an Issue**
   - If you have a new feature idea, a bug report, or any other improvement suggestion, start by creating an issue on the [Issues](https://github.com/soenneker/soenneker.deduplication.slidingwindow.registry/issues) page.
...
1. **Create a Pull Request**
   - Go to the [Pull Requests](https://github.com/soenneker/soenneker.deduplication.slidingwindow.registry/pulls) page of the original repository.
